    ...
    >
      ...
      <g>
        <g transform="rotate(45 -50.355 121.569)">
          <circle r={8} fill="black" fillOpacity=".875">
            <animateTransform
              attributeName="transform"
              type="scale"
              begin="-0.75s"
      ...
      <g>
        <g transform="rotate(90 -15 65)">
          <circle r={8} fill="black" fillOpacity=".75">
            <animateTransform
              attributeName="transform"
              type="scale"
              begin="-0.625s"
      ...
      <g>
        <g transform="rotate(135 -.355 41.569)">
          <circle r={8} fill="black" fillOpacity=".625">
            <animateTransform
              attributeName="transform"
              type="scale"
              begin="-0.5s"
      ...
      <g>
        <g transform="rotate(180 10 25)">
          <circle r={8} fill="black" fillOpacity=".5">
            <animateTransform
              attributeName="transform"
              type="scale"
              begin="-0.375s"
      ...
      <g>
        <g transform="rotate(-135 20.355 8.431)">
          <circle r={8} fill="black" fillOpacity=".375">
            <animateTransform
              attributeName="transform"
              type="scale"
              begin="-0.25s"
      ...
      <g>
        <g transform="rotate(-90 35 -15)">
          <circle r={8} fill="black" fillOpacity=".25">
            <animateTransform
              attributeName="transform"
              type="scale"
              begin="-0.125s"
      ...
      <g>
        <g transform="rotate(-45 70.355 -71.569)">
          <circle r={8} fill="black" fillOpacity=".125">
            <animateTransform
              attributeName="transform"
              type="scale"
              begin="0s"
